...
version (DigitalMars)
    ...
    case OPbswap:
        switch (tysize(tym))
        {
            ...
            case 8:
                e.EV.Vllong = ((l1 >> 56) & 0x00000000_000000FF) |
                              ((l1 >> 40) & 0x00000000_0000FF00) |
                              ((l1 >> 24) & 0x00000000_00FF0000) |
                              ((l1 >>  8) & 0x00000000_FF000000) |
                              ((l1 <<  8) & 0x000000FF_00000000) |
                              ((l1 << 24) & 0x0000FF00_00000000) |
                              ((l1 << 40) & 0x00FF0000_00000000) |
                              ((l1 << 56) & 0xFF000000_00000000);
                break;
