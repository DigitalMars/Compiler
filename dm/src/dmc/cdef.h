...
#define VERSION "8.57.0"        // for banner and imbedding in .OBJ file
#define VERSIONHEX "0x857"      // for __DMC__ macro
#define VERSIONINT 0x857        // for precompiled headers and DLL version
