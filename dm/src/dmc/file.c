...
#include	<string.h>
#include	<ctype.h>
#if !HOST_UNIX && !(linux || __APPLE__ || __FreeBSD__)
#include	<io.h>
#include	<share.h>
#endif
#include	<stdlib.h>
#include	<fcntl.h>
#include	<time.h>
#if M_UNIX || HOST_UNIX || linux || __APPLE__ || __FreeBSD__
#include	<sys/stat.h>
#include	<unistd.h>
#else
#include	<sys\stat.h>
...
#if TX86 && !(linux || __APPLE__ || __FreeBSD__)
	__asm
	{
		mov	ESI,b
		xor	DL,DL
...
int file_exists(const char *fname)
{
	...
	result = 0;
    return result;
#elif HOST_UNIX || linux || __APPLE__ || __FreeBSD__
    struct stat buf;
